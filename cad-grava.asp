...
<!--#INCLUDE file="alert.asp" -->
    ...
    pega_data()
        ...
        if ususim = "não" then
            ...
            sqlstmt = "insert into usuarios (statu, nome, email, senha, perfil, cpf, data_cadastro, hora_cadastro) values ('" & statu & "', '" & nome & "', '" & email & "', '" & md5(senha) & "'," & perfil & ", '" & cpf & "',  '" & wDataAtual & "', '" & wHoraAtual & "')"
            response.write sqlstmt
