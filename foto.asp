        ...
        <div class="content-wrapper" style="background-color: transparent;">
				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12" align="right">
						  <form action="foto-incluir.asp" method="post">
			...
			<section style="max-width: none;" class="content">
				<div class="container-fluid">
                  ...
                  <tbody>
                      <%
                      sqlstmt = "SELECT  q.numero, f.codigo, f.nome_foto, f.caminho FROM fotos f "
                      sqlstmt = sqlstmt & " LEFT JOIN quartos q ON f.quarto = q.codigo "
                      ...
                      <tr>
                          ...
                          <td><%response.write rsquery("nome_foto")%></td>
                          <td><%response.write rsquery("caminho")%></td>
