	...
	action: function ( e, dt, button, config ) {
		...
		if ( document.queryCommandSupported('copy') ) {
			...
			try {
				...
				if (successful) {
					dt.buttons.info(
						dt.i18n( 'buttons.copyTitle', 'Cópia para transferência' ),
						dt.i18n( 'buttons.copySuccess', {
							1: 'Copied one row para transferência',
							_: 'Copied %d rows para transferência'
						}, exportData.rows ),
						2000
					);
		...
		dt.buttons.info( dt.i18n( 'buttons.copyTitle', 'Cópia para transferência' ), message, 0 );
