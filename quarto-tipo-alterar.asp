...
<div class="wrapper">
  ...
  sqlstmt = "select * from tipo_quarto where codigo=" & request("pid")
              ...
              <div class="col-md-12">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="rcbfocus form-control" name="descricao" value="<%response.write rsquery("descricao")%>" />
                    </div>
                    <div class="col-md-3">
                        <label>Valor da diaria</label>
                        <input type="number" class="rcbfocus form-control" name="valor" value="<%response.write rsquery("valor_diaria")%>" />
                    </div>
                    <div class="col-md-2">
                        <label>Capacidade</label>
                        <input type="number" class="rcbfocus form-control" name="capacidade" value="<%response.write rsquery("capacidade")%>" />
                    </div>
                    <div class="col-md-2" style="top: 30px;"  align="right">
                        <button onclick="lancar();" class="btn btn-info">Incluir</button>
                    </div>
                </div>
              </div>
            </div>
