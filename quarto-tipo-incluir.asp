                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" class="rcbfocus form-control" name="descricao" />
                                    </div>
                                    <div class="col-md-3">
                                        <label>Valor da diaria</label>
                                        <input type="number" class="rcbfocus form-control" name="valor" />
                                    </div>
                                    <div class="col-md-2">
                                        <label>Capacidade</label>
                                        <input type="number" class="rcbfocus form-control" name="capacidade" />
                                    </div>
