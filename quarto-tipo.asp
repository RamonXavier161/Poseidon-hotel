				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12" align="right">
						  <form action="quarto-tipo-incluir.asp" method="post">
							...
							<div class="card card-success">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<% 
											sqlstmt= "SELECT * FROM tipo_quarto"
											...
											<tr>
                                                ...
                                                <td><%response.write FormatCPF(rsquery("valor_diaria"))%></td> 
												<td><%response.write rsquery("capacidade")%></td>
												<td><a href="quarto-tipo-alterar.asp?pid=<%response.write rsquery("codigo")%>"><i class="fas fa-edit"></i></a></td>
