				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12" align="right">
						  <form action="quarto-incluir.asp" method="post">
							...
							<div class="card card-success">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<% 
											sqlstmt= "SELECT q.* , tp.descricao FROM quartos q"
                                            sqlstmt= sqlstmt & " left join tipo_quarto tp on q.tipo = tp.codigo"
											...
											<tr>
												...
												<td><%response.write rsquery("numero")%></td>
                                                <td><%response.write FormatCPF(rsquery("andar"))%></td> 
												<td><%response.write rsquery("descricao")%></td>
                                                <td><%response.write rsquery("status")%></td>
												<td><a href="quarto-alterar.asp?pid=<%response.write rsquery("codigo")%>"><i class="fas fa-edit"></i></a></td>
