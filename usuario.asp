				...
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-12" align="right">
						  <form action="usuario-incluir.asp" method="post">
							...
							<div class="card card-success">
								...
								<div class="card-body">
									<table id="example1" class="table table-bordered table-striped">
										...
										<tbody>
											<% 
											sqlstmt= "SELECT u.* FROM usuarios u"
											...
											%>
											<tr>
												<td><%response.write rsquery("idusuario")%></td>
												<td><%response.write rsquery("nome")%></td>
                                                <td><%response.write FormatCPF(rsquery("cpf"))%></td> 
												<td><%response.write rsquery("telefone")%></td>
